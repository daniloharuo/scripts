...
# print hostname
#/usr/bin/env figlet -f slant "$(hostname -s)"
#/usr/bin/env figlet -f slant "$(hostname -s)"
...
IFS=" " read SWAP_USED SWAP_FREE SWAP_TOTAL <<<$(free -htm | grep "Swap" | awk {'print $3,$4,$2'})
...
$W  Kernel......: $W$(uname -sr)
$W  Hostname....: $W$(hostname -s)
$W  Domain......: $W$(hostname -d)$W"
...
$W  Swap........: $G$SWAP_USED$W used, $G$SWAP_FREE$W free, $G$SWAP_TOTAL$W total$W"
...
services=("besclient" "sshd" "sssd" "splunk" "traps_trapsd" "rsyslog")
# sort services
...
if [ -e /tmp/updates_notification_count ] ; then
  UPDATES_COUNT=$(cat /tmp/updates_notification_count)
